...
class Board {
  ...
  getNumberOfNeighborBombs (rowIndex, columnIndex) {
    ...
    neighborOffsets.forEach(offset => {
      ...
      if (neighborRowIndex >= 0 && neighborRowIndex < this._numberOfRows && this._neighborColumnIndex >= 0 && this._neighborColumnIndex < this._numberOfColumns) {
...
}; // closing bracket for Board


// Playing the Game //

const g = new Game(10,10, 4);
g.playMove(1, 1);
